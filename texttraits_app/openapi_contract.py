...
def build_openapi_spec(base_url: str) -> dict[str, Any]:
    ...
    return {
        ...
        "paths": {
            ...
            "/v1/b2b/profile": {
                "post": {
                    "tags": ["B2B profile intelligence"],
                    "operationId": "buildB2BProfile",
                    "summary": "Build a privacy-safe business profile from consented communication history.",
                    "requestBody": json_request("B2BProfileRequest"),
                    "responses": {"200": json_response("B2BProfileResponse"), "400": error_response("Invalid request"), "413": error_response("Payload too large")},
                }
            },
...
def schemas() -> dict[str, Any]:
    ...
    return {
        ...
        "B2BProfileRequest": {
            "type": "object",
            "required": ["communication_history"],
            "properties": {
                "communication_history": {"type": "string"},
        ...
        "B2BProfileResponse": {
            "type": "object",
            "required": ["api_version", "profile_id", "privacy", "safe_features", "business_profile", "resonance_strategy"],
            "properties": {
                "api_version": {"type": "string"},
                "profile_engine_version": {"type": "string"},
                "profile_id": {"type": "string"},
                "generated_at": {"type": "string"},
                "campaign_goal": {"type": "string"},
                "privacy": {"type": "object"},
                "safe_features": {"type": "object"},
                "business_profile": {"type": "object"},
                "resonance_strategy": {"type": "object"},
                "activation": {"type": "object"},
                "model_stack": {"type": "object"},
            },
        },
        "Finding": finding,
        "Gate": gate,
...
def build_install_kit(base_url: str) -> dict[str, Any]:
    ...
    return {
        ...
        "sample_payloads": [
            ...
            "samples/b2b-profile-request.json",
        ...
        "integration_sequence": [
            ...
            "Build minimized relationship profiles with /v1/b2b/profile when outreach strategy needs account-level context.",
