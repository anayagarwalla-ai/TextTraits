...
- Branch intended for the public app: `main` after the production-readiness merge is pushed.
...
- `codex/production-readiness` contains the production app, account, persistence, security, and workflow work. Deploy `main` only after it includes that merge commit.
