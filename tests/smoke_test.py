...
def main() -> int:
    ...
    assert_true("Explore writing patterns carefully" in html, "public heading missing")
    assert_true("Use this responsibly" in html, "responsible-use acknowledgement missing")
    assert_true("Model reading will appear here" in html, "model reading empty state missing")
